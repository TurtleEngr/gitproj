...
This it used by the S<"git proj init"> command.
...
See the "common-options" section in L<git-proj|git-proj.html> for details.
...
When a project has been successfully setup by S<git proj init> or
...
=head2 gpAllowTabs; -NA; gitproj.hook.check-for-tabs; (false)
